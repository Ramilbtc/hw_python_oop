...
class InfoMessage:
    ...
    def __init__(self,
                 training_type: str, # Тип тренировки (бег, ходьба или плавание)
                 duration: float, # Длительность тренировки (время)
                 distance: float, # Дистанция, которую преодолел пользователь (км)
...
def read_package(workout_type: str, data: list) -> Training:
    ...
    param_tr = {
        "SWM" : Swimming, # сопоставление кодов и классов
        "RUN" : Running,
        "WLK" : SportsWalking
        }
